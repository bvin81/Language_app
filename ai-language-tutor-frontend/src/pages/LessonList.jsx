...
export default function LessonList({ onSelectLesson, user }) {  // user hozzáadva
    ...
    <div style={{ padding: "2rem" }}>
      ...
      {lessons.length === 0 ? (
        ...
        <div style={{ display: "grid", gap: "1rem" }}>
          {lessons.map((lesson) => {
            const isLocked = lesson.is_premium && !user?.is_premium;  // új
                ...
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "start" }}>
                  ...
                  <button
                    ...
                    style={{
                      ...
                      backgroundColor: isLocked ? "#fb923c" : "#4ade80",
                      color: "#fff",
                      border: "none",
                      borderRadius: "6px",
                    }}
